...
const results = [
  {
    ...
    description:
      "Redução de custos operacionais através de automações e otimizações",
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Resultados que <span className="text-blue-600">Comprovam</span>{" "}
            Nossa Eficiência
          </h2>
            ...
            {cases.map((case_, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="text-blue-600 mr-3">{case_.icon}</div>
